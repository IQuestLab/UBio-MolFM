...
[ -z "${data_path_list}" ] && data_path_list="${PROJECT_ROOT}/data/OC20/s2ef/2M/train"
[ -z "${data_path_list_valid}" ] && data_path_list_valid="${PROJECT_ROOT}/data/OC20/s2ef/all/val_id"
...
[ -z "${MASTER_PORT}" ] && MASTER_PORT=62362
...
export data_path_list="${PROJECT_ROOT}/data/OC20/s2ef/2M/train"
export data_path_list_valid="${PROJECT_ROOT}/data/OC20/s2ef/all/val_id"
export dataset_name_list="oc20"
export dataset_micro_batch_size="atom:2048"
export gradient_accumulation_steps=1
export total_num_steps=120000
...
torchrun $DISTRIBUTED_ARGS src/molfm/tasks/pretrain_smallmol.py \
          ...
          lr=0.0002 \
          weight_decay=0.001 \
          energy_loss_weight=2 force_loss_weight=100 \
          clip_grad_norm=100 \
          ...
          backbone_config.irreps_node_embedding="256x0e+256x1e+256x2e+256x3e" \
          backbone_config.irreps_head="1x0e+1x1e+1x2e+1x3e" \
          ...
          backbone_config.max_neighbors=64 \
          backbone_config.alpha_drop=0.1 \
